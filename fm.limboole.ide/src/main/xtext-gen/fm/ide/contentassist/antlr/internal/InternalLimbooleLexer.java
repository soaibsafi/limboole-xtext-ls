...
public class InternalLimbooleLexer extends Lexer {
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1040:17: ( '%' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalLimboole.g:1040:19: '%' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match('%'); 
            // InternalLimboole.g:1040:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_VAR() throws RecognitionException {
        try {
            int _type = RULE_VAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1042:10: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '.' | '[' | ']' | '$' | '@' | '0' .. '9' )* ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '[' | ']' | '$' | '@' | '0' .. '9' ) )
            // InternalLimboole.g:1042:12: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '.' | '[' | ']' | '$' | '@' | '0' .. '9' )* ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '.' | '[' | ']' | '$' | '@' | '0' .. '9' )
            {
            // InternalLimboole.g:1042:12: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '.' | '[' | ']' | '$' | '@' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1044:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalLimboole.g:1044:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalLimboole.g:1044:11: ( '^' )?
            int alt5=2;
            ...
            // InternalLimboole.g:1044:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1046:10: ( ( '0' .. '9' )+ )
            // InternalLimboole.g:1046:12: ( '0' .. '9' )+
            {
            // InternalLimboole.g:1046:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalLimboole.g:1046:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1048:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalLimboole.g:1048:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalLimboole.g:1048:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalLimboole.g:1048:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalLimboole.g:1048:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalLimboole.g:1048:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalLimboole.g:1048:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1050:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalLimboole.g:1050:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalLimboole.g:1050:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1052:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalLimboole.g:1052:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalLimboole.g:1052:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalLimboole.g:1054:16: ( . )
            // InternalLimboole.g:1054:18: .
            {
            matchAny(); 
    ...
    static final String DFA13_eotS =
        "\1\uffff\2\21\6\uffff\1\23\1\21\1\23\1\uffff\3\21\4\uffff\1\42\6\uffff\1\23\1\uffff\1\23\5\uffff";
    static final String DFA13_eofS =
        "\43\uffff";
    static final String DFA13_minS =
        "\1\0\1\44\1\55\6\uffff\1\60\1\101\1\60\1\uffff\2\0\1\52\4\uffff\1\76\6\uffff\1\60\1\uffff\1\60\5\uffff";
    static final String DFA13_maxS =
        "\1\uffff\1\172\1\55\6\uffff\2\172\1\71\1\uffff\2\uffff\1\52\4\uffff\1\76\6\uffff\1\172\1\uffff\1\71\5\uffff";
    static final String DFA13_acceptS =
        "\3\uffff\1\4\1\5\1\6\1\7\1\10\1\11\3\uffff\1\12\3\uffff\1\17\1\20\1\1\1\12\1\uffff\1\4\1\5\1\6\1\7\1\10\1\11\1\uffff\1\13\1\uffff\1\15\1\16\1\17\1\3\1\2";
    static final String DFA13_specialS =
        "\1\1\14\uffff\1\2\1\0\24\uffff}>";
    static final String[] DFA13_transitionS = {
            "\11\21\2\20\2\21\1\20\22\21\1\20\1\5\1\15\1\21\1\14\1\10\1\4\1\16\1\6\1\7\3\21\1\1\1\14\1\17\12\13\2\21\1\2\3\21\1\14\32\11\1\14\1\21\1\14\1\12\1\11\1\21\32\11\1\21\1\3\uff83\21",
            "\1\23\10\uffff\2\23\1\uffff\12\23\4\uffff\1\22\1\uffff\34\23\1\uffff\1\23\1\uffff\1\23\1\uffff\32\23",
            "\1\24",
            "",
            "",
            "",
